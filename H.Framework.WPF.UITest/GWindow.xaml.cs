...
namespace H.Framework.WPF.UITest
{
    ...
    public partial class GWindow : Window
    {
        ...
        public static void PushIosMsg(PushType pushType, bool isProduc, dynamic tagjsonobj, string starttime, string title, string content, string description)
        {
        ...
        public static void PushAndroidMsg(PushType pushType, bool isProduc, dynamic tagjsonobj, string starttime, string title, string content, string description)
        {
